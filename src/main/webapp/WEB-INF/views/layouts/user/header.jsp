...
<header>
	...
	<div class="navbar__action">
		<div class="navbar-list">
			<p href="" onclick="listCartBtnClick()" class="navbar-list-btn">
				<i class="fa-solid fa-clipboard-list"></i><span>1</span>
			</p>
			<div class="list-container">
				<div class="list-room">
					<img
						src="https://images.unsplash.com/photo-1593006526979-5f8814c229f9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cm9vbSUyMGhvdGVsfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
						alt="">
